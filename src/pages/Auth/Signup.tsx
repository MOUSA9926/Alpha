  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/unauthorized-domain') {
        ...
        setError("حدث خطأ أثناء إنشاء الحساب بواسطة Google.");
      }
    }
  };
      ...
      <div className="min-h-screen flex flex-col relative z-10" dir="rtl">
        ...
        <div className="flex-1 flex items-center justify-center p-4 mb-10">
          ...
          >
            ...
            <div className="absolute -bottom-32 -right-32 w-64 h-64 bg-orange-500/20 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl font-black text-center text-white mb-2">إنشاء حساب</h2>
              <p className="text-gray-400 text-center mb-8 font-medium">انضم إلينا لمتابعة الأفلام المفضلة لديك</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300 mr-1 block" htmlFor="name">الاسم</label>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pr-11 pl-4 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all font-medium"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300 mr-1 block" htmlFor="password">كلمة المرور</label>
                  <div className="relative">
                ...
                <button 
                  type="submit"
                  className="w-full py-3.5 px-4 bg-gradient-to-r from-orange-500 to-cyan-500 hover:from-orange-400 hover:to-cyan-400 text-white rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(249,115,22,0.2)] hover:shadow-[0_0_30px_rgba(34,211,238,0.3)] mt-2"
                >
                  حساب جديد
                </button>
              </form>
              ...
              <div className="mt-6">
                ...
                <button
                  ...
                  className="mt-6 w-full flex justify-center items-center py-3.5 px-4 border border-white/10 rounded-xl shadow-sm bg-white/5 text-sm font-bold text-white hover:bg-white/10 transition-all focus:outline-none focus:border-orange-500/50"
                >
              ...
              <div className="mt-8 text-center border-t border-white/10 pt-6">
                <p className="text-gray-400 text-sm font-medium">
                  لديك حساب بالفعل؟{' '}
                  <Link to="/login" className="text-white hover:text-orange-400 font-bold transition-colors">
                    تسجيل الدخول
                  </Link>
                </p>
              </div>
